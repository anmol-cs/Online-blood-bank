    ...
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                loginCom = new SqlCommand("SELECT email,Password FROM donor WHERE email = @email AND Password = @password", loginCon);
        ...
        {
            donar_registeration f1 = new donar_registeration();
            f1.Show();
            this.Hide();
        }
